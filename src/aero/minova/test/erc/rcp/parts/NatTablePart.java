...
package aero.minova.test.erc.rcp.parts;
...
import aero.minova.test.erc.rcp.dataset.person.PersonService;
import aero.minova.test.erc.rcp.dataset.person.Person.Gender;
...
public class NatTablePart {
	...
	public void postConstruct(Composite parent) {
		...
		String[] propertyNames = {	"firstName", "lastName", "password", "description", "age", "money", "married", "gender", "address.street", "address.city",
...
class EditorConfiguration extends AbstractRegistryConfiguration {
	...
	private void registerColumnTwoTextEditor(IConfigRegistry configRegistry) {
		...
		configRegistry.registerConfigAttribute(EditConfigAttributes.CELL_EDITOR, new TextCellEditor(true, true), DisplayMode.NORMAL,
				NatTablePart.COLUMN_TWO_LABEL);

		// configure to open the adjacent editor after commit
		configRegistry.registerConfigAttribute(EditConfigAttributes.OPEN_ADJACENT_EDITOR, Boolean.TRUE, DisplayMode.EDIT, NatTablePart.COLUMN_TWO_LABEL);
		...
		configRegistry.registerConfigAttribute(EditConfigAttributes.EDIT_DIALOG_SETTINGS, editDialogSettings, DisplayMode.EDIT, NatTablePart.COLUMN_TWO_LABEL);
	}
	...
	private void registerColumnThreePasswordEditor(IConfigRegistry configRegistry) {
		...
		configRegistry.registerConfigAttribute(EditConfigAttributes.CELL_EDITOR, new PasswordCellEditor(), DisplayMode.NORMAL,
				NatTablePart.COLUMN_THREE_LABEL);

		// configure the password editor to not support multi editing
		configRegistry.registerConfigAttribute(EditConfigAttributes.SUPPORT_MULTI_EDIT, Boolean.FALSE, DisplayMode.EDIT, NatTablePart.COLUMN_THREE_LABEL);

		// note that you should also register the corresponding
		// PasswordTextPainter
		// to ensure that the password is not rendered in clear text
		configRegistry.registerConfigAttribute(CellConfigAttributes.CELL_PAINTER, new PasswordTextPainter(), DisplayMode.NORMAL,
				NatTablePart.COLUMN_THREE_LABEL);
	}
	...
	private void registerColumnFourMultiLineEditor(IConfigRegistry configRegistry) {
		...
		configRegistry.registerConfigAttribute(EditConfigAttributes.CELL_EDITOR, new MultiLineTextCellEditor(false), DisplayMode.NORMAL,
				NatTablePart.COLUMN_FOUR_LABEL);

		// configure the multi line text editor to always open in a subdialog
		configRegistry.registerConfigAttribute(EditConfigAttributes.OPEN_IN_DIALOG, Boolean.TRUE, DisplayMode.EDIT, NatTablePart.COLUMN_FOUR_LABEL);

		Style cellStyle = new Style();
		cellStyle.setAttributeValue(CellStyleAttributes.HORIZONTAL_ALIGNMENT, HorizontalAlignmentEnum.LEFT);
		configRegistry.registerConfigAttribute(CellConfigAttributes.CELL_STYLE, cellStyle, DisplayMode.NORMAL, NatTablePart.COLUMN_FOUR_LABEL);
		configRegistry.registerConfigAttribute(CellConfigAttributes.CELL_STYLE, cellStyle, DisplayMode.EDIT, NatTablePart.COLUMN_FOUR_LABEL);
	...
	private void registerColumnFiveIntegerEditor(IConfigRegistry configRegistry) {
		...
		// after commit
		configRegistry.registerConfigAttribute(EditConfigAttributes.CELL_EDITOR, new TextCellEditor(false, true), DisplayMode.NORMAL,
				NatTablePart.COLUMN_FIVE_LABEL);

		// configure to open the adjacent editor after commit
		configRegistry.registerConfigAttribute(EditConfigAttributes.OPEN_ADJACENT_EDITOR, Boolean.TRUE, DisplayMode.EDIT, NatTablePart.COLUMN_FIVE_LABEL);

		// configure to open always in dialog to show the tick update in normal
		// mode
		configRegistry.registerConfigAttribute(EditConfigAttributes.OPEN_IN_DIALOG, Boolean.TRUE, DisplayMode.EDIT, NatTablePart.COLUMN_FIVE_LABEL);
	...
	private void registerColumnSixDoubleEditor(IConfigRegistry configRegistry) {
		...
		// after commit
		configRegistry.registerConfigAttribute(EditConfigAttributes.CELL_EDITOR, new TextCellEditor(false, true), DisplayMode.NORMAL,
				NatTablePart.COLUMN_SIX_LABEL);

		// configure to open the adjacent editor after commit
		configRegistry.registerConfigAttribute(EditConfigAttributes.OPEN_ADJACENT_EDITOR, Boolean.TRUE, DisplayMode.EDIT, NatTablePart.COLUMN_SIX_LABEL);

		// configure to open always in dialog to show the tick update in normal
		// mode
		configRegistry.registerConfigAttribute(EditConfigAttributes.OPEN_IN_DIALOG, Boolean.TRUE, DisplayMode.EDIT, NatTablePart.COLUMN_SIX_LABEL);

		// configure the tick update dialog to use the adjust mode
		configRegistry.registerConfigAttribute(TickUpdateConfigAttributes.USE_ADJUST_BY, Boolean.TRUE, DisplayMode.EDIT, NatTablePart.COLUMN_SIX_LABEL);

		// don't forget to register the Double converter!
		configRegistry.registerConfigAttribute(CellConfigAttributes.DISPLAY_CONVERTER, new DefaultDoubleDisplayConverter(), DisplayMode.NORMAL,
				NatTablePart.COLUMN_SIX_LABEL);
	}

	/**
	 * The following will register a default CheckBoxCellEditor for the column that carries the married information. To register a CheckBoxCellEditor, you need
	 * to Register the editor Register the painter corresponding to that editor Register the needed converter
	 * 
	...
	private void registerColumnSevenCheckbox(IConfigRegistry configRegistry) {
		...
		configRegistry.registerConfigAttribute(EditConfigAttributes.CELL_EDITOR, new CheckBoxCellEditor(), DisplayMode.EDIT, NatTablePart.COLUMN_SEVEN_LABEL);
		...
		configRegistry.registerConfigAttribute(CellConfigAttributes.CELL_PAINTER, new CheckBoxPainter(), DisplayMode.NORMAL, NatTablePart.COLUMN_SEVEN_LABEL);
		...
		configRegistry.registerConfigAttribute(CellConfigAttributes.DISPLAY_CONVERTER, new DefaultBooleanDisplayConverter(), DisplayMode.NORMAL,
				NatTablePart.COLUMN_SEVEN_LABEL);
	}

	/**
	 * The following will register a CheckBoxCellEditor with custom icons for the column that carries the gender information. As a Gender is not a Boolean,
	 * there need to be a special converter registered. Note that such a converter needs to create a Boolean display value and create the canonical value out of
	 * a Boolean value again. To register a CheckBoxCellEditor, you need to Register the editor Register the painter corresponding to that editor Register the
	 * needed converter
	 * 
	 * @param configRegistry
	 */
	private void registerColumnEightCheckbox(IConfigRegistry configRegistry) {
		...
		configRegistry.registerConfigAttribute(EditConfigAttributes.CELL_EDITOR, new CheckBoxCellEditor(), DisplayMode.EDIT, NatTablePart.COLUMN_EIGHT_LABEL);
		...
		configRegistry.registerConfigAttribute(CellConfigAttributes.CELL_PAINTER,
				new CheckBoxPainter(GUIHelper.getImage("arrow_up"), GUIHelper.getImage("arrow_down")), DisplayMode.NORMAL, NatTablePart.COLUMN_EIGHT_LABEL);

		// using a CheckBoxCellEditor also needs a Boolean conversion to work
		// correctly
		configRegistry.registerConfigAttribute(CellConfigAttributes.DISPLAY_CONVERTER, getGenderBooleanConverter(), DisplayMode.NORMAL,
				NatTablePart.COLUMN_EIGHT_LABEL);
	}

	/**
	 * The following will register a ComboBoxCellEditor for the column that carries the street information. To register a ComboBoxCellEditor, you only need to
	 * register the editor itself. On click to the cell you want to edit, the dropdown will open. If you want to indicate in the view that this cell is editable
	 * by combobox, you need to register the corresponding painter.
	 *
	 * @param configRegistry
	 */
	private void registerColumnNineComboBox(IConfigRegistry configRegistry) {
		...
		configRegistry.registerConfigAttribute(EditConfigAttributes.CELL_EDITOR, comboBoxCellEditor, DisplayMode.EDIT, NatTablePart.COLUMN_NINE_LABEL);
	}

	/**
	 * The following will register a ComboBoxCellEditor for the column that carries the city information. The difference to the editor in column six is that the
	 * text control of the combobox is editable and the combobox shows all entries instead of a scrollbar.
	 *
	 * @param configRegistry
	 */
	private void registerColumnTenComboBox(IConfigRegistry configRegistry) {
		...
		configRegistry.registerConfigAttribute(EditConfigAttributes.CELL_EDITOR, comboBoxCellEditor, DisplayMode.EDIT, NatTablePart.COLUMN_TEN_LABEL);

		configRegistry.registerConfigAttribute(CellConfigAttributes.CELL_PAINTER, new ComboBoxPainter(), DisplayMode.NORMAL, NatTablePart.COLUMN_TEN_LABEL);
	}

	/**
	 * The following will register a ComboBoxCellEditor for the column that carries the favourite food information. This ComboBoxCellEditor will support
	 * multiple selection. It also adds a different icon for the combo in edit mode.
	 *
	 * @param configRegistry
	 */
	private void registerColumnElevenComboBox(IConfigRegistry configRegistry) {
		...
		}, DisplayMode.NORMAL, NatTablePart.COLUMN_ELEVEN_LABEL);

		comboBoxCellEditor.setIconImage(GUIHelper.getImage("plus"));
		configRegistry.registerConfigAttribute(EditConfigAttributes.CELL_EDITOR, comboBoxCellEditor, DisplayMode.EDIT, NatTablePart.COLUMN_ELEVEN_LABEL);
	}

	/**
	 * The following will register a ComboBoxCellEditor for the column that carries the favourite drinks information. The difference to the editor in column
	 * eight is that the text control of the combobox is editable and the combobox shows all entries instead of a scrollbar. It also uses a different icon for
	...
	private void registerColumnTwelveComboBox(IConfigRegistry configRegistry) {
		...
		comboBoxCellEditor.setMultiselect(true);
		comboBoxCellEditor.setIconImage(GUIHelper.getImage("plus"));
		configRegistry.registerConfigAttribute(EditConfigAttributes.CELL_EDITOR, comboBoxCellEditor, DisplayMode.EDIT, NatTablePart.COLUMN_TWELVE_LABEL);

		configRegistry.registerConfigAttribute(CellConfigAttributes.CELL_PAINTER, new ComboBoxPainter(GUIHelper.getImage("plus")), DisplayMode.NORMAL,
				NatTablePart.COLUMN_TWELVE_LABEL);
	}

	/**
	 * The following will register a {@link FileDialogCellEditor} for the filename column. This will open the default SWT FileDialog to support file selection.
	 *
	 * @param configRegistry
	 */
	private void registerColumnThirteenFileDialogEditor(IConfigRegistry configRegistry) {
		configRegistry.registerConfigAttribute(EditConfigAttributes.CELL_EDITOR, new FileDialogCellEditor(), DisplayMode.EDIT,
				NatTablePart.COLUMN_THIRTEEN_LABEL);
	}

	/**
	 * @return Returns a simple converter for the gender of a Person. {@link Gender#MALE} will be interpreted as true while {@link Gender#FEMALE} will be
